...
COMMUNITY_LINK = os.getenv(
    "COMMUNITY_LINK",
    "https://t.me/+k-BE0h6uWCNmMjRk"  # <-- الرابط المطلوب
)
...
# ===== نصوص اللغتين =====
AR_WELCOME = (
    "مرحبا فيكم في قروبكم GSG\n"
    "🙋🏻‍♀️🩷نمارس الرياضة معـاً 🩷 🙋🏻‍♀️\n\n"
    "💡القوانين مثبتة و إلزامية لكل عضوة قبل المشاركة\n"
    "🔗 رابط المنصة\n"
    "{community}"
)

EN_WELCOME = (
    "Welcome to your group GSG\n"
    "🙋🏻‍♀️🩷 We do sports together 🩷🙋🏻‍♀️\n\n"
    "💡The rules are pinned and mandatory for every member before participating\n"
    "🔗 Platform link\n"
    "{community}"
)
