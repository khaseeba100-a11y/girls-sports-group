...
# رابط قروب تيليجرام: من ENV لو موجود وإلا الافتراضي تحت
COMMUNITY_LINK = os.getenv(
    "COMMUNITY_LINK",
    "https://t.me/+FINsrYoOEuU1YWFk"
)
...
AR_WELCOME = (
    ...
    "بعد الموافقة، هذا رابط قروبنا على تيليجرام:\n"
    "{community}\n\n"
    "❗️مهم:\n"
    "- اقرئي القوانين قبل المشاركة.\n"
)

EN_WELCOME = (
    "Hello 🙋🏻‍♀️\n"
    "Girls Sports Group — a women’s sports group to share and join activities together.\n\n"
    "After approval, here is our Telegram group link:\n"
    "{community}\n\n"
    "❗️Important:\n"
